...
link = 'https://chromewebstore.google.com/detail/helperbird-accessibility/ahmapmilbkfamljbpgphfndeemhnajme/reviews'
...
def main():
    with sync_playwright() as p:
        ...
        # url = actor_input.get('url', 'https://chromewebstore.google.com/detail/chatgpt-organize-with-fol/jijhgfapogfphcccjlpoiphpjgedblpo/reviews')
        # Load the page
        page.goto(link)
